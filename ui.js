  ...
  <div style="background:linear-gradient(135deg,#0f172a,#1e293b,#0f172a);border-radius:var(--r3);padding:24px 20px;margin-bottom:16px;position:relative;overflow:hidden">
    ...
    <div style="text-align:center;position:relative;z-index:1">
      ...
      <div class="profile-avatar-container" onclick="document.getElementById('avatar-upload').click()">
        <img id="profile-avatar" src="" alt="" onerror="this.style.display='none'">
        <div id="avatar-fallback" style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--accent-bg);">
